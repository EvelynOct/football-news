...
SECRET_KEY = 'django-insecure-(kz2(pm-oz30jb03h+49a4rnm8=p3$+@t5guy#8er4_x6u)ko@'
...
ALLOWED_HOSTS = ["localhost", "127.0.0.1", "evelyne-octaviana-footballnews.pbp.cs.ui.ac.id", "10.0.2.2"]
